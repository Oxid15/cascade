...
.. doctest::
    ...
    >>> ds = cdd.ApplyModifier(ds, square)
    >>> list(ds)
    [0, 1, 4, 9, 16]
...
.. doctest::
    ...
    (array([datetime.datetime(2022, 11, 5, 0, 0),
           ...
           datetime.datetime(2022, 11, 8, 0, 0)], dtype=object), array([1, 0, 2, 5]))

Install matplotlib if required

Run ``pip3 install matplotlib`` if required.
...
.. doctest::
    ...
    >>> Interpolate(ds, method='linear', limit_direction='both').to_pandas()
                  0
    2022-11-05  0.0
    2022-11-06  1.0
    2022-11-07  2.0
